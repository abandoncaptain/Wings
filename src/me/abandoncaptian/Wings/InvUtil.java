...
public class InvUtil {
	...
	public ArrayList<ItemStack> permParticles(Player p){
		...
		if(p.hasPermission("perkeffects.wings.flame")){
			ItemStack item = new ItemStack(Material.PAPER, 1);
			ItemMeta iM = item.getItemMeta();
		...
		if(p.hasPermission("perkeffects.wings.enchantment_table")){
		...
		if(p.hasPermission("perkeffects.wings.spell")){
		...
		if(p.hasPermission("perkeffects.wings.crit_magic")){
		...
		if(p.hasPermission("perkeffects.wings.crit")){
		...
		if(p.hasPermission("perkeffects.wings.note")){
		...
		if(p.hasPermission("perkeffects.wings.spell_instant")){
			ItemStack item = new ItemStack(Material.POTION, 1);
			ItemMeta iM = item.getItemMeta();
		...
		if(p.hasPermission("perkeffects.wings.water_wake")){
		...
		if(p.hasPermission("perkeffects.wings.spell_mob")){
			ItemStack item = new ItemStack(Material.PAPER, 1);
			ItemMeta iM = item.getItemMeta();
		...
		if(p.hasPermission("perkeffects.wings.spell_witch")){
			ItemStack item = new ItemStack(Material.PAPER, 1);
			ItemMeta iM = item.getItemMeta();
		...
		if(p.hasPermission("perkeffects.wings.spell_mob_ambient")){
			ItemStack item = new ItemStack(Material.PAPER, 1);
			ItemMeta iM = item.getItemMeta();
		...
		if(p.hasPermission("perkeffects.wings.suspended_depth")){
			ItemStack item = new ItemStack(Material.PAPER, 1);
			ItemMeta iM = item.getItemMeta();
		...
		if(p.hasPermission("perkeffects.wings.villager_happy")){
		...
		if(p.hasPermission("perkeffects.wings.water_splash")){
